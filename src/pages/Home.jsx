// ✅ 완성형 Home.jsx (프리미엄 결제, 매칭 제한, 감정/스타일 필터, 채팅 포함 + 모든 오류 수정본)
...
<h1 className="text-3xl font-bold text-center text-gray-800 mb-8">랜덤 동행 감성 여행 만들기</h1>
    ...
    <button onClick={handleGeneratePlan}
      ...
      {isLoading ? "매칭 중입니다..." : "랜덤 매칭 하기"}
    </button>

    <button onClick={handlePremiumPayment}
      className="w-full mt-4 bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 rounded-full transition duration-300 shadow-md">
      프리미엄으로 결제하기 (₩3,900)
    </button>
